...
$mth_blk_subscription_form_id= ( isset( $option_fields['mth_blk_subscription_form_id'] ) ) ? $option_fields['mth_blk_subscription_form_id'] : null;
			...
			<div class="footer-topbar">
				<div class="container">
					<div class="row-block">
						...
						<div class="col-block">
							<h6>Email</h6>
							<span class="text"><a href="mailto:info@modeltownhospital.com.pk"><?php echo $mtl_blk_footer_contact_email;?></a></span>
						</div>
						<div class="col-block">
							<h6>Location</h6>
					...
					<div class="row-block">
						<div class="col-block">
							<ul class="social-networks">
								<li><a href="<?php echo $basethemevar_social_fb;?>" class="fab fa-facebook-f"></a></li>
								<li><a href="<?php echo $basethemevar_social_tw;?>" class="fab fa-twitter"></a></li>
								<li><a href="<?php echo $basethemevar_social_li;?>" class="fab fa-youtube"></a></li>
								<li><a href="<?php echo $basethemevar_social_in;?>" class="fab fa-instagram"></a></li>
							</ul>
